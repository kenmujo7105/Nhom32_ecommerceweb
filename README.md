...
- **Trang chủ & Sản phẩm**: Xem danh sách sản phẩm, lọc và tìm kiếm, xem chi tiết sản phẩm.
- **Giỏ hàng & Thanh toán**: Thêm sản phẩm vào giỏ, đặt hàng, tích hợp thanh toán an toàn qua **Stripe**.
